...
P(Win)= β0 ​+ β1​(Party) + β2​(Gender) + β3​(Race) + β4​(Incumbent) + ϵ
...
P(Win) = β0 ​+ β1​(Gender) + β2​(Race) + β3​(Incumbent) + ϵ
